    ...
    return (
      <div className="container">
        ...
        <div className="textBox">
          ...
          <a className="links" target="_blank" href="https://www.linkedin.com/in/donell-ellis/">[ LinkedIn ]</a>
          <a className="links" target="_blank" href="https://github.com/donellellis">[ GitHub ]</a>
        </div>
      </div>
    );
  }
